 ...
 */
final class Version20251212081614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_detail ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
