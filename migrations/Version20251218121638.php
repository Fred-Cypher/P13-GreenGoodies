 ...
 */
final class Version20251218121638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_detail CHANGE order_id_id order_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_detail CHANGE order_id order_id_id INT NOT NULL');
